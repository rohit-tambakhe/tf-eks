...
output "cloudwatch_alarm_arns" {
  ...
  value       = module.monitoring.cloudwatch_alarm_arns
}
...
output "connection_instructions" {
  ...
  value = <<-EOT
    ...
    5. Check monitoring namespace:
       kubectl get pods -n monitoring
    
    Note: This is a production cluster with private API endpoint access only.
    Ensure you are connecting from an authorized network or VPN.
  EOT
}
