...
module "eks_cluster" {
  ...
  vpc_id                                = module.vpc.vpc_id
  subnet_ids                            = var.endpoint_public_access ? concat(module.vpc.public_subnet_ids, module.vpc.private_subnet_ids) : module.vpc.private_subnet_ids
...
module "addons" {
  ...
  enable_efs_csi_driver                             = var.enable_efs_csi_driver
  efs_csi_driver_service_account_role_arn           = module.iam_with_oidc.efs_csi_driver_role_arn
  enable_aws_load_balancer_controller               = var.enable_aws_load_balancer_controller
